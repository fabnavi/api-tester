...
localStorage.setItem("header", "{\"Client\":\"fkM9OzXrsfvcZILHdmr7Ig\",\"Uid\":\"3610296\",\"AccessToken\":\"FbhWgDKCKDUYMS21NaEBSw\"}");
...
const WebAPIUtils = {
  ...
  getCurrentUserInfo : function(){
    ...
    $.ajax({
      ...
      headers : genHeader(),
      url : baseUrl + "/api/v1/current_user.json"
    });
  },
  ...
  getProject : function( id ){
    ...
    $.ajax({
      ...
      headers : genHeader(),
      url : baseUrl + "/api/v1/projects/" + id + ".json"
    });
  },
  ...
  getOwnProjects : function( uid ){
    ...
    $.ajax({
      ...
      headers : genHeader(),
      url : baseUrl + "/api/v1/users/" + uid + "/projects.json"
    });
  },
  ...
  getAllProjects : function( page, perPage, offset ){
    ...
    $.ajax({
      ...
      url : baseUrl + "/api/v1/projects.json"
  ...
  setThumbnailLast : function( project ){
    ...
    $.ajax({
      ...
      url : baseUrl + "/api/v1/projects/" + project.id + ".json"
    });
  },
  ...
  updateProject : function( project ){
    ...
    let fileElem = document.querySelector("#sensor_info");
    /*
    let i;
    ...
    */
        ...
        fd.append("project[sensor_infos_attributes][][id]", 0);
        fd.append("project[sensor_infos_attributes][][data]", "hogepiyo");//fileElem.files[0]);
        fd.append("project[sensor_infos_attributes][][_destroy]", "false");
  ...
  uploadFile : function( file, name, sym ){
    ...
    $.ajax({
      ...
      url : baseUrl + "/api/v1/attachments.json"
    });
  },
